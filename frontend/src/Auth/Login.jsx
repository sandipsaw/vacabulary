...
const Login = () => {
  ...
  return (
    <>
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(16,185,129,0.18),_transparent_30%),linear-gradient(135deg,_#020617,_#111827)] px-4 py-10 sm:px-6 lg:px-8 lg:block hidden">
      ...
      <form onSubmit={handleSubmit(LoginHandler)} className="flex-1 rounded-3xl border border-slate-800 bg-slate-900/80 p-6 lg:hidden block">
          <h2 className="text-2xl font-bold text-white">Login</h2>
          <p className="mt-2 text-sm text-slate-400">Enter your email and password to continue.</p>
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(16,185,129,0.18),_transparent_30%),linear-gradient(135deg,_#020617,_#111827)] px-4 py-10 sm:px-6 lg:px-8 lg:hidden block">
      <form onSubmit={handleSubmit(LoginHandler)} className="flex-1 rounded-3xl border border-slate-800 bg-slate-900/80 p-6 lg:hidden block">
          <h2 className="text-2xl font-bold text-white">Login</h2>
          <p className="mt-2 text-sm text-slate-400">Enter your email and password to continue.</p>
